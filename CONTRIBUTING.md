...
The Amero Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ameropay/amero/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Amero Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Amero
Network Protocol consensus changes.

Whether a pull request is merged into Amero Core rests with the project merge
...
Patches that change Amero consensus rules are considerably more involved than
...
Where a patch set proposes to change the Amero consensus, it must have been
...
The review process is normally fairly responsive on the Amero Core repository, however
