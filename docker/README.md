...
official/supported Docker Images found at https://hub.docker.com/r/dashpay/amerod/
...
**NOTE: Please update the image description at https://hub.docker.com/r/dashpay/amerod-develop/ when changing the above text**