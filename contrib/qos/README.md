...
This means one can have an always-on amerod instance running, and another local amerod/dash-qt instance which connects to this node and receives blocks from it.
