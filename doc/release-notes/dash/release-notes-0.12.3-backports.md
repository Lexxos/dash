...
- [`43f697866`](https://github.com/ameropay/amero/commit/43f697866) Merge #9108: Use importmulti timestamp when importing watch only keys (on top of #9682)
...
- [`24be65e87`](https://github.com/ameropay/amero/commit/24be65e87) Merge #10328: Update contrib/debian to latest Ubuntu PPA upload.
...
- [`a16d3b005`](https://github.com/ameropay/amero/commit/a16d3b005) Merge #9829: Fix importmulti returning rescan errors for wrong keys
...
- [`fe0ef87cd`](https://github.com/ameropay/amero/commit/fe0ef87cd) Merge #9720: net: fix banning and disallow sending messages before receiving verack
...
- [`228d774a6`](https://github.com/ameropay/amero/commit/228d774a6) Fix use of distdir and docker build dir
...
- [`87229e06c`](https://github.com/ameropay/amero/commit/87229e06c) Merge #9469: [depends] Qt 5.7.1
...
- [`eb7a6b08f`](https://github.com/ameropay/amero/commit/eb7a6b08f) Merge #8811: rpc: Add support for JSON-RPC named arguments
...
- [`465ceff3b`](https://github.com/ameropay/amero/commit/465ceff3b) Use ForceSetArg/ForceSetMultiArgs in debug rpc command
...
- [`45727e797`](https://github.com/ameropay/amero/commit/45727e797) Merge #9303: Update comments in ctaes
...
- [`dadfc45b1`](https://github.com/ameropay/amero/commit/dadfc45b1) Add size() method to CVectorWriter
...
- [`dc4fdd9ff`](https://github.com/ameropay/amero/commit/dc4fdd9ff) Merge #9164: [trivial] credit values are CAmount
...
- [`29a59e518`](https://github.com/ameropay/amero/commit/29a59e518) Remove NodeEvictionCandidate constructor and revert to struct initializion
...
- [`d38c7f1d4`](https://github.com/ameropay/amero/commit/d38c7f1d4) Merge #9020: rpc: Remove invalid explanation from wallet fee message
...
- [`239ce534c`](https://github.com/ameropay/amero/commit/239ce534c) Merge #8914: Kill insecure_random and associated global state
...
- [`79f6d3d30`](https://github.com/ameropay/amero/commit/79f6d3d30) Merge #8832: [rpc] throw JSONRPCError when utxo set can not be read
...
- [`97b63420d`](https://github.com/ameropay/amero/commit/97b63420d) Merge #8656: Trivial: Do not shadow global variable fileout
...
- [`85c0aabc1`](https://github.com/ameropay/amero/commit/85c0aabc1) Merge #8667: Fix SIGHASH_SINGLE bug in test_framework SignatureHash
...
- [`30066a600`](https://github.com/ameropay/amero/commit/30066a600) Merge #8109: Do not shadow member variables
...
- [`6b8160ba2`](https://github.com/ameropay/amero/commit/6b8160ba2) Merge #8513: Fix a type error that would not compile on OSX.
...
- [`e7da254c5`](https://github.com/ameropay/amero/commit/e7da254c5) Merge #8407: [Qt] Add dbcache migration path
...
- [`f8a7a2c88`](https://github.com/ameropay/amero/commit/f8a7a2c88) Move bitcoin.ico/png and bitcoin_testnet.ico/png one dir up
- [`a9f0aedb3`](https://github.com/ameropay/amero/commit/a9f0aedb3) Merge #8320: Fix 0.12 release notes on block relaying
- [`6a993236b`](https://github.com/ameropay/amero/commit/6a993236b) Remove SegWit related checks added by backporting of Bitcoin #8295
- [`f9f3b8d93`](https://github.com/ameropay/amero/commit/f9f3b8d93) Merge #8295: Mining-related fixups for 0.13.0
- [`bc257c1a0`](https://github.com/ameropay/amero/commit/bc257c1a0) Merge #8305: Improve handling of unconnecting headers
- [`26540aa5d`](https://github.com/ameropay/amero/commit/26540aa5d) Merge #8289: bash-completion: Adapt for 0.12 and 0.13
- [`167047297`](https://github.com/ameropay/amero/commit/167047297) Merge #8314: Fix pkg-config issues for 0.13
- [`e6b071ab0`](https://github.com/ameropay/amero/commit/e6b071ab0) Merge #8315: gitian: Don't require sudo for Linux.
- [`237ba56d9`](https://github.com/ameropay/amero/commit/237ba56d9) Merge #8303: [Doc] Update bips.md for CSV softfork.
- [`7a6febfaa`](https://github.com/ameropay/amero/commit/7a6febfaa) Merge #8310: build: require boost for bench
- [`5ff5474e4`](https://github.com/ameropay/amero/commit/5ff5474e4) Merge #8304: [travis] Update SDK_URL
- [`25627e31d`](https://github.com/ameropay/amero/commit/25627e31d) Merge #8288: qt: Network-specific example address
- [`355f3724d`](https://github.com/ameropay/amero/commit/355f3724d) Merge #8298: wallet: Revert input selection post-pruning
- [`2c914e8ba`](https://github.com/ameropay/amero/commit/2c914e8ba) Merge #8280: Tests: Increase sync_blocks() timeouts in pruning.py
- [`dcf36df67`](https://github.com/ameropay/amero/commit/dcf36df67) Merge #8285: windows: Add testnet link to installer
- [`ba6b36978`](https://github.com/ameropay/amero/commit/ba6b36978) Merge #8281: qt: Remove client name from debug window
- [`17aa23c88`](https://github.com/ameropay/amero/commit/17aa23c88) Merge #8261: The bit field is shown only when status is "started"
- [`7f5b8f1e1`](https://github.com/ameropay/amero/commit/7f5b8f1e1) Merge #8258: RPC: Hide softfork if timeout is 0
- [`f1f139033`](https://github.com/ameropay/amero/commit/f1f139033) Merge #8252: [trivial] Add aarch64 to depends .gitignore
- [`3f7273d00`](https://github.com/ameropay/amero/commit/3f7273d00) Merge #8256: BUG: bitcoin-qt crash
- [`5a844dcc4`](https://github.com/ameropay/amero/commit/5a844dcc4) Merge #8254: [doc] Add OSX ZMQ requirement to QA readme
- [`b7b5d6ea7`](https://github.com/ameropay/amero/commit/b7b5d6ea7) Merge #8246: trivial: capitalize BIP32 in option help
- [`e51f50544`](https://github.com/ameropay/amero/commit/e51f50544) Merge #8222: Enable mempool consistency checks in unit tests
- [`381629c75`](https://github.com/ameropay/amero/commit/381629c75) Merge #8229: [Doc] Update OS X build notes for 10.11 SDK
- [`e2bcf8ae0`](https://github.com/ameropay/amero/commit/e2bcf8ae0) Merge #8216: [qa] assert 'changePosition out of bounds'
- [`c2dabf8bd`](https://github.com/ameropay/amero/commit/c2dabf8bd) Merge #8220: Stop trimming when mapTx is empty
- [`36aa55458`](https://github.com/ameropay/amero/commit/36aa55458) Temporarily fix build error cased by out-of-order backporting
- [`808936cc3`](https://github.com/ameropay/amero/commit/808936cc3) Merge #8179: Evict orphans which are included or precluded by accepted blocks.
- [`573d9314e`](https://github.com/ameropay/amero/commit/573d9314e) Merge #7713: Fixes for verify-commits script
- [`d2c3b7efe`](https://github.com/ameropay/amero/commit/d2c3b7efe) Merge #7687: Stop treating importaddress'ed scripts as change
- [`782745b05`](https://github.com/ameropay/amero/commit/782745b05) Merge #8066: [qa] test_framework: Use different rpc_auth_pair for each node
- [`68757db68`](https://github.com/ameropay/amero/commit/68757db68) Merge #8210: [Qt] Bump to Qt5.6.1
- [`05684db6e`](https://github.com/ameropay/amero/commit/05684db6e) Merge #8203: Clarify documentation for running a tor node
- [`b6d8206c2`](https://github.com/ameropay/amero/commit/b6d8206c2) Merge #8224: readme: Omit phrasing; 'new'
- [`46473757e`](https://github.com/ameropay/amero/commit/46473757e) Merge #8215: [wallet] tests: Don't use floating point
- [`6227cfdad`](https://github.com/ameropay/amero/commit/6227cfdad) Merge #8214: [qa] mininode: fail on send_message instead of silent return
- [`f362c610e`](https://github.com/ameropay/amero/commit/f362c610e) Merge #7600: Mining: Select transactions using feerate-with-ancestors
- [`79ad5f768`](https://github.com/ameropay/amero/commit/79ad5f768) Bump univalue version
- [`c783b39ce`](https://github.com/ameropay/amero/commit/c783b39ce) Merge #8171: [RPC] Fix createrawtx sequence number unsigned int parsing
- [`402eb5573`](https://github.com/ameropay/amero/commit/402eb5573) Merge #8208: Do not set extra flags for unfiltered DNS seed results
- [`9875ab535`](https://github.com/ameropay/amero/commit/9875ab535) Merge #8207: [trivial] Add a link to the Bitcoin-Core repository and website to the About Dialog
- [`96180a189`](https://github.com/ameropay/amero/commit/96180a189) Merge #7636: Add bitcoin address label to request payment QR code
- [`62852538e`](https://github.com/ameropay/amero/commit/62852538e) Merge #8198: [trivial] Sync ax_pthread with upstream draft4
- [`61a667fc4`](https://github.com/ameropay/amero/commit/61a667fc4) Merge #8194: [gitian] set correct PATH for wrappers
- [`2b4e896f6`](https://github.com/ameropay/amero/commit/2b4e896f6) Merge #8197: [trivial] Ignore split-debug.sh
- [`0c6122634`](https://github.com/ameropay/amero/commit/0c6122634) Also revert BLOCK_DOWNLOAD_TIMEOUT_PER_PEER to 500000
- [`c7937c202`](https://github.com/ameropay/amero/commit/c7937c202) Remove unnecessary call to AddInventoryKnown in INV message handling
- [`e3ca41b1c`](https://github.com/ameropay/amero/commit/e3ca41b1c) Ameroify build-osx.md
- [`49f9d613b`](https://github.com/ameropay/amero/commit/49f9d613b) Revert to BLOCK_DOWNLOAD_TIMEOUT_BASE = 1000000
- [`f00aeb87c`](https://github.com/ameropay/amero/commit/f00aeb87c) Fix failing test in p2p-fullblocktest.py
- [`05c8f2ee2`](https://github.com/ameropay/amero/commit/05c8f2ee2) Ameroify new tests in bitcoin-util-test.json
- [`2e51d8273`](https://github.com/ameropay/amero/commit/2e51d8273) Merge #8201: [qa] fundrawtransaction: Fix race, assert amounts
- [`e7e3a8071`](https://github.com/ameropay/amero/commit/e7e3a8071) Merge #8141: Continuing port of java comparison tool
- [`6a698300a`](https://github.com/ameropay/amero/commit/6a698300a) Merge #7598: Refactor CreateNewBlock to be a method of the BlockAssembler class
- [`6ef8aae76`](https://github.com/ameropay/amero/commit/6ef8aae76) Merge #8193: [trivial][doc] Use Debian 8.5 in the gitian-build guide
- [`06a73ad7c`](https://github.com/ameropay/amero/commit/06a73ad7c) Merge #8188: Add armhf/aarch64 gitian builds
- [`acbda5d16`](https://github.com/ameropay/amero/commit/acbda5d16) Merge #8177: developer notes: updates for C++11
- [`b95a338b3`](https://github.com/ameropay/amero/commit/b95a338b3) Merge #8133: build: Finish up out-of-tree changes
- [`79db88bbb`](https://github.com/ameropay/amero/commit/79db88bbb) Merge #8181: build: Get rid of `CLIENT_DATE`
- [`209a4d63b`](https://github.com/ameropay/amero/commit/209a4d63b) Merge #8178: Add git and github tips and tricks to developer notes
- [`b9a00f629`](https://github.com/ameropay/amero/commit/b9a00f629) Merge #7292: [RPC] Expose ancestor/descendant information over RPC
- [`856e54678`](https://github.com/ameropay/amero/commit/856e54678) Merge #7283: [gitian] Default reference_datetime to commit author date
- [`2e3aacf43`](https://github.com/ameropay/amero/commit/2e3aacf43) Merge #8166: src/test: Do not shadow local variables
- [`aa6cb48bf`](https://github.com/ameropay/amero/commit/aa6cb48bf) Merge #8154: drop vAddrToSend after sending big addr message
- [`ca228f09f`](https://github.com/ameropay/amero/commit/ca228f09f) Merge #8168: util: Add ParseUInt32 and ParseUInt64
- [`cfc76bab9`](https://github.com/ameropay/amero/commit/cfc76bab9) Merge #8172: Fix two warnings for comparison between signed and unsigned
- [`a60d4d64c`](https://github.com/ameropay/amero/commit/a60d4d64c) Remove 'LDFLAGS=-static-libstdc++' from CONFIGFLAGS in gitian-linux.yml
- [`80d02d8f5`](https://github.com/ameropay/amero/commit/80d02d8f5) Use nRelevantServices for requiredServiceBits
- [`b3e26cc75`](https://github.com/ameropay/amero/commit/b3e26cc75) Merge #8083: Add support for dnsseeds with option to filter by servicebits
- [`361d26037`](https://github.com/ameropay/amero/commit/361d26037) Merge #8173: Use SipHash for node eviction (cont'd)
- [`fc7b5778f`](https://github.com/ameropay/amero/commit/fc7b5778f) Merge #7993: [depends] Bump Freetype, ccache, ZeroMQ, miniupnpc, expat
- [`05419aba3`](https://github.com/ameropay/amero/commit/05419aba3) Merge #8153: [rpc] fundrawtransaction feeRate: Use BTC/kB
- [`ca699ceba`](https://github.com/ameropay/amero/commit/ca699ceba) Merge #8126: std::shared_ptr based CTransaction storage in mempool
- [`51fa05ac3`](https://github.com/ameropay/amero/commit/51fa05ac3) Merge #8082: Defer inserting into maprelay until just before relaying.
- [`881d8329c`](https://github.com/ameropay/amero/commit/881d8329c) Merge #7703: tor: Change auth order to only use password auth if -torpassword
- [`00c84ca53`](https://github.com/ameropay/amero/commit/00c84ca53) Merge #8065: Addrman offline attempts
- [`2ee817fb0`](https://github.com/ameropay/amero/commit/2ee817fb0) Merge #8078: Disable the mempool P2P command when bloom filters disabled
- [`0b8169d49`](https://github.com/ameropay/amero/commit/0b8169d49) Merge #8164: [Bitcoin-Tx] fix missing test fixtures, fix 32bit atoi issue
- [`9af87c826`](https://github.com/ameropay/amero/commit/9af87c826) Merge #7957: [RPC][Bitcoin-TX] Add support for sequence number
- [`d5d25564c`](https://github.com/ameropay/amero/commit/d5d25564c) Merge #8136: Log/report in 10% steps during VerifyDB
- [`7f0213ac3`](https://github.com/ameropay/amero/commit/7f0213ac3) Merge #8118: Reduce unnecessary hashing in signrawtransaction
- [`49c2e9702`](https://github.com/ameropay/amero/commit/49c2e9702) Merge #8151: [init] Make feefilter option debug option
- [`b2bd69a7a`](https://github.com/ameropay/amero/commit/b2bd69a7a) Merge #8142: Improve CWallet API  with new GetAccountPubkey function.
- [`463a68d4a`](https://github.com/ameropay/amero/commit/463a68d4a) Merge #8007: Minor locking improvements
- [`d7d5d577f`](https://github.com/ameropay/amero/commit/d7d5d577f) Merge #8137: Improve CWallet API with new AccountMove function.
- [`7538795b1`](https://github.com/ameropay/amero/commit/7538795b1) Merge #8143: comment nit: miners don't vote
- [`c69df9b82`](https://github.com/ameropay/amero/commit/c69df9b82) Merge #7967: [RPC] add feerate option to fundrawtransaction
- [`af51e591b`](https://github.com/ameropay/amero/commit/af51e591b) Merge #8139: Fix interrupted HTTP RPC connection workaround for Python 3.5+
- [`fb88e9b60`](https://github.com/ameropay/amero/commit/fb88e9b60) Merge #7997: replace mapNextTx with slimmer setSpends
- [`df14a7f00`](https://github.com/ameropay/amero/commit/df14a7f00) Merge #7825: Prevent multiple calls to ExtractDestination
- [`dbf4dc4de`](https://github.com/ameropay/amero/commit/dbf4dc4de) Merge #8029: [Doc] Simplify OS X build notes
- [`fefd0ace3`](https://github.com/ameropay/amero/commit/fefd0ace3) Merge #8077: Consensus: Decouple from chainparams.o and timedata.o
- [`bf069fb1b`](https://github.com/ameropay/amero/commit/bf069fb1b) Merge #8123: Use std::atomic for fRequestShutdown and fReopenDebugLog
