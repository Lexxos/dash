...
"""Verify that starting amerod with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start amerod with -h for help text")
        ...
        self.log.info("Start amerod with -version for version information")
