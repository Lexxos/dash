#!/usr/bin/env python3
# Copyright (c) 2015-2021 The Amero Core developers
...
class LLMQCoinbaseCommitmentsTest(AmeroTestFramework):
    def set_test_params(self):
        self.set_amero_test_params(4, 3, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as AmeroTestFramework doesn't support this atm)
