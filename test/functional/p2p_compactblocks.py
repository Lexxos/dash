...
# TestP2PConn: A peer we use to send messages to amerod, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes amerod to (reasonably!) disconnect us, so do this last.
    ...
    # Test that amerod requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for amerod to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # amerod will not send blocktxn responses for blocks whose height is
