#!/usr/bin/env python3
# Copyright (c) 2015-2020 The Amero Core developers
...
class BlockRewardReallocationTest(AmeroTestFramework):
    def set_test_params(self):
        self.set_amero_test_params(2, 1, fast_dip3_enforcement=True)
        self.set_amero_dip8_activation(450)
